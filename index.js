...
const body = (type === 'listResponseMessage' && mek.message.listResponseMessage.title) ? mek.message.listResponseMessage.title : (type === 'buttonsResponseMessage' && mek.message.buttonsResponseMessage.selectedButtonId) ? mek.message.buttonsResponseMessage.selectedButtonId : (type === 'conversation' && mek.message.conversation.startsWith(prefix)) ? mek.message.conversation : (type == 'imageMessage') && mek.message.imageMessage.caption.startsWith(prefix) ? mek.message.imageMessage.caption : (type == 'videoMessage') && mek.message.videoMessage.caption.startsWith(prefix) ? mek.message.videoMessage.caption : (type == 'extendedTextMessage') && mek.message.extendedTextMessage.text.startsWith(prefix) ? mek.message.extendedTextMessage.text : (type == 'stickerMessage') && (getCmd(mek.message.stickerMessage.fileSha256.toString('base64')) !== null && getCmd(mek.message.stickerMessage.fileSha256.toString('base64')) !== undefined) ? getCmd(mek.message.stickerMessage.fileSha256.toString('base64')) : ""
    ...
    const antivirtex = JSON.parse(
      ...
      const add2 = JSON.parse(fs.readFileSync("./database/add2.json"));
      const kick2 = JSON.parse(fs.readFileSync("./database/kick2.json"));
      const men = JSON.parse(fs.readFileSync("./database/men.json"));
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`918602239106@s.whatsapp.net`]
...
/*const reply = (teks) => {
			Olduser.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/918602239106?text=hello`}}})
		}*/
...
const fakewa = (teks) => {        
Olduser.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Olduser`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/918602239106?text=hello`}}})
		}
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/918602239106`,
                "mediaType": "10",
                "mediaUrl": `wa.me/918602239106`,
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/918602239106`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "918602239106@s.whatsapp.net";
...
groups = Olduser.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "918602239106@s.whatsapp.net"
        dtod = '918602239106'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
case 'bugreport':
              ...
              Olduser.sendMessage('918602239106@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'script':
		case 'sc':
		case 'sourcecode':
		Olduser.sendMessage(from, { text: "https://github.com/jetushack1/bot-doge-olduser", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		case 'script':
		case 'code':
		case 'sourcecode':
		Olduser.sendMessage(from, { text:"https://github.com/jetushack1/bot", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
case 'mygithub':
  reply('https://github.com/jetushack1/bot-doge-olduser')
					break;
   case 'ss':
      reply(mess.wait)
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/jetushack1/bot-doge-olduser"
        },
        "index": 0
      }
    ]
